...
db.restaurant.find({borough: "Bronx", cuisine: {$in:["American","Chinese"]}},{_id:0});
...
db.restaurants.find({ location: { $geoWithin: { $centerSphere: [[-74, 40.7], 5 / 6378.1] } } }, { _id: 0, restaurant_id: 1, name: 1, "address.street": 1, "address.zipcode": 1, "location.coordinates": 1 });
